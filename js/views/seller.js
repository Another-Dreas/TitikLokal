...
export const initSellerOrders = async () => {
    window.TitikLokal = window.TitikLokal || {};
    window.TitikLokal.formatters = window.TitikLokal.utils || {
        number: (num) => new Intl.NumberFormat('id-ID').format(num || 0),
        date: (d) => d ? new Intl.DateTimeFormat('id-ID').format(new Date(d)) : 'Baru Saja'
    };
    if (!window.TitikLokal.formatters.date && window.TitikLokal.utils && window.TitikLokal.utils.dateString) {
        window.TitikLokal.formatters.date = window.TitikLokal.utils.dateString;
    }
    if (!window.TitikLokal.formatters.number && window.TitikLokal.utils && window.TitikLokal.utils.number) {
        window.TitikLokal.formatters.number = window.TitikLokal.utils.number;
    }
